        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item">
                       <select name="select" id="select" class="form-select outline-none"
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class=" mb-5 mb-md-0" src="{{asset('img/'.$product->image)}}" alt="..." /></div>
                <div class="col-md-6">
                    <div class="small mb-1">Product code : {{$product->id}}</div>
                    ...
                    <div class="d-flex">
                        ...
                        <a class="btn btn-outline-dark border" href="{{url('/add-to-cart/'.$product->id)}}">
                            <i class="bi-cart-fill me-1"></i>
                            Add Cart
                        </a>
                    </div>
                    ...
                    <a href="{{url('/show/'.$product->id)}}" style="text-decoration: none; color: black;">
                        <div class="card p-3">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{url('/show/'.$product->id)}}">View</a></div>
                            </div>
                        </div>
                    </a>
                </div>
